...
export const dbQueries = {
  ...
  exportTableQueries: {
    ...
    emailTokens: `CREATE TABLE IF NOT EXISTS emailTokens (token VARCHAR(255) NOT NULL PRIMARY KEY, action VARCHAR(255) NOT NULL, UID INT(255) UNSIGNED NOT NULL REFERENCES users(ID), expiryDate TIMESTAMP NOT NULL)`,
  },
}
