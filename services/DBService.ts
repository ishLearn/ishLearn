...
export const dbQueries = {
  ...
  exportTableQueries: {
    ...
    refreshtokens: `CREATE TABLE IF NOT EXISTS refreshtokens (token VARCHAR(255) NOT NULL PRIMARY KEY, UID INT(255) UNSIGNED NOT NULL REFERENCES users(ID), expiryDate DATE NOT NULL)`,
  },
}
